        ...
        (function() {
            $(function() {
                ...
                editor = new Simditor({
                    ...
                    placeholder: '{{ t('Describe your job posting ad, don\'t forget to include the number of people you wish to hire for the position, the qualifications, skill set required, responsibilities etc.') }}...',
                    toolbar: toolbar,
                    pasteImage: false,
