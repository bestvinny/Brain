		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 page-content">
					...
					<div class="inner-box">
						<h2 class="title-2"><strong> <i class="icon-docs"></i> {{ t('Add Company Information') }}</strong></h2>

						<form name="details" class="form-horizontal" role="form" method="POST" action="{{ lurl('profile/insertcomp') }}">
											{!! csrf_field() !!}
