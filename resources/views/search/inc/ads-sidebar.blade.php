	...
	<aside>
		<div class="inner-box">
				...
				<div class="filter-salary filter-content ">
					<form role="form" class="form-inline" action="{{ $fullUrlNoParams }}" method="GET">
						...
						<div class="form-group col-sm-3 no-padding">
							<button class="btn btn-primary pull-right btn-block-xs" type="submit">{{ t('GO') }}</button>
						</div>
					</form>
			...
			<div class="locations-list list-filter">
				<h5 class="left-side-bar"></h5>
				@include('layouts.inc.advertising.left-side-bar')
				<h5 class="home-bot-right"></h5>
			</div>
			<!--/.list-filter-->
