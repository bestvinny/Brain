    ...
    */
    ...
    public function __construct()
    {
        ...
        if (config('settings.require_users_activation') == 1) {
            $this->msg['signup']['success'] = "Your account has been created. An activation link has been sent to the email used for registration, please check and activate. If you did not receive this email, please check your junk/spam folder.";
        } else {
            $this->msg['signup']['success'] = "Your account has been created.";
        }
        $this->msg['activation']['success'] = "Congratulations :first_name ! Your account has been activated.";
    ...
    public function register(Request $request)
    {
        ...
        $userInfo = [
            ...
            'education_id'     => $request->input('level'),
        ...
        if ($request->input('user_type') == 3 || $request->input('user_type') == 4) {
        ...
        if ($request->input('user_type') == 4) {
                ...
                $parent = new ParentGuardian($parentInfo);
                $parent->save();
        }
