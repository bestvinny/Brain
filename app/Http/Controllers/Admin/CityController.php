    ...
    public function __construct()
    {
        ...
        */
        ...
        $this->xPanel->addField([
            ...
            'hint'       => __t('Code for the first administrative division. Please check the admin1 code format here:') . ' <a href="//download.geonames.org/export/dump/admin1CodesASCII.txt" target="_blank">http://download.geonames.org/export/dump/admin1CodesASCII.txt</a>',
        ]);
        $this->xPanel->addField([
            'name'       => 'subadmin2_code',
            'label'      => __t("Admin2 Code"),
            ...
            'hint'       => __t('Code for the second administrative division. Please check the admin2 code format here:') . ' <a href="//download.geonames.org/export/dump/admin2Codes.txt" target="_blank">http://download.geonames.org/export/dump/admin2Codes.txt</a>',
        ]);
        $this->xPanel->addField([
            'name'       => 'population',
        ...
        $this->xPanel->addField([
            ...
            'hint'       => __t('Please check the TimeZoneId code format here:') . ' <a href="//download.geonames.org/export/dump/timeZones.txt" target="_blank">http://download.geonames.org/export/dump/timeZones.txt</a>',
        ]);
        $this->xPanel->addField([
            'name'  => 'active',
            'label' => __t("Active"),
