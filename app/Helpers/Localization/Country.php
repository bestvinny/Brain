...
class Country
{
    ...
    // Maxmind Support URL
    private static $maxmind_support_url = 'https://support.maxmind.com/';
    ...
    public function setCountryParameters()
    {
        ...
        if (!Auth::check() and !in_array(getSegment(1), [
            ...
            $msg = 'Login for faster access to the best job positions. Click here if you don\'t have an account.';
