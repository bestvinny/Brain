-- Geonames.org updates SQL Import for Brain Train
-- 
-- Author: Wanekeya Sam
-- https://www.wanekeyasam.co.ke/
--
--
-- As you already know, Brain Train uses the Geonames databases from:
-- http://download.geonames.org/export/dump/
--
-- Here is the correspondence between the Brain Train’s tables and Geonames’s data:
