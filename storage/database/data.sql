...
('app_name', 'Company', 'BrainTrainKe', 'The Company Name', '{"name":"value","label":"Value","type":"text"}', 0, 2, 13, 1, 1, NULL, '2016-11-03 17:30:11'),
('app_logo', 'Logo', NULL, 'Company Logo', '{"name":"value","label":"Logo","type":"image","upload":"true","disk":"uploads","default":"app/default/logo.png"}', 0, 3, 4, 1, 1, NULL, '2016-06-14 22:27:49'),
('app_slogan', 'Meta Title', 'BrainTrainKe - Jobs in Kenya | Your Job Finder | Career Resource Center', 'Meta Title which will also act as the Website slogan', '{"name":"value","label":"Value","type":"text"}', 0, 5, 6, 1, 1, NULL, '2016-11-03 17:30:24'),
...
('app_email', 'Primary Email', 'admin@domain.com', 'The primary email address receiving all emails from the contact form.', '{"name":"value","label":"Value","type":"email"}', 0, 9, 10, 1, 1, NULL, '2016-11-03 15:41:13'),
('app_phone_number', 'Phone number', NULL, 'Company phone number', '{"name":"value","label":"Value","type":"text"}', 0, 11, 12, 1, 1, NULL, '2016-06-14 22:27:49'),
('activation_geolocation', 'Activate Geolocation', '0', 'Enable website Geolocation for the entire website', '{"name":"value","label":"Activation","type":"checkbox"}', 0, 16, 21, 1, 1, NULL, '2016-10-23 08:21:20'),
...
('activation_country_flag', 'Country flag display', '1', 'Display the country flag on top of the page', '{"name":"value","label":"Activation","type":"checkbox"}', 0, 19, 20, 1, 1, NULL, '2016-10-23 08:21:20'),
...
('require_users_activation', 'Users activation required', '0', 'Users required to activate account after signup', '{"name":"value","label":"Required","type":"checkbox"}', 0, 25, 26, 1, 1, NULL, '2016-10-23 08:21:20'),
...
('activation_social_login', 'Social Login Activation', '0', 'Allow users to login using their social media accounts', '{"name":"value","label":"Required","type":"checkbox"}', 0, 44, 45, 1, 1, NULL, '2016-10-23 08:21:20'),
('activation_facebook_comments', 'Facebook comments activation', '0', 'Allow Facebook comments within a page', '{"name":"value","label":"Required","type":"checkbox"}', 0, 42, 43, 1, 1, NULL, '2016-10-23 08:21:20'),
('show_powered_by', 'Show more footer', '1', 'Show Powered by/All rights reserved info', '{"name":"value","label":"Activation","type":"checkbox"}', 0, 32, 33, 1, 1, NULL, '2016-10-23 08:21:20'),
('google_site_verification', 'Google Webmaster Tools', NULL, 'Enter the verification code to verify the site with Google Webmaster Tools', '{"name":"value","label":"Value","type":"text"}', 0, 34, 37, 1, 1, NULL, '2016-10-23 08:21:20'),
('msvalidate', 'Bing Webmaster Center', NULL, 'Enter the verification code to verify the site with Bing Webmaster Tools', '{"name":"value","label":"Value","type":"text"}', 0, 33, 34, 1, 1, NULL, '2016-06-14 22:28:49'),
('alexa_verify_id', 'Alexa site verification', NULL, 'Enter your verification code to verify the site with Alexa', '{"name":"value","label":"Value","type":"text"}', 0, 35, 36, 1, 1, NULL, '2016-06-14 22:28:49'),
...
('facebook_page_url', 'Facebook - Page URL', 'https://www.facebook.com/braintrainke', 'Company Facebook Page URL', '{"name":"value","label":"Value","type":"text"}', 0, 46, 55, 1, 1, NULL, '2016-10-29 10:47:03'),
('facebook_page_id', 'Facebook - Page ID', '806182476160185', 'Company Facebook personal numeric ID (Not username)', '{"name":"value","label":"Value","type":"text"}', 0, 49, 50, 1, 1, NULL, '2016-10-23 08:21:20'),
('facebook_client_id', 'Facebook Client ID', '', 'Facebook App ID', '{"name":"value","label":"Value","type":"text"}', 0, 51, 52, 1, 1, NULL, '2016-10-23 08:21:20'),
('facebook_client_secret', 'Facebook Client Secret', '', 'Facebook App Secret', '{"name":"value","label":"Value","type":"text"}', 0, 53, 54, 1, 1, NULL, '2016-10-23 08:21:20'),
...
('twitter_url', 'Twitter - URL', 'https://twitter.com/braintrainke', 'Website Twitter URL', '{"name":"value","label":"Value","type":"text"}', 0, 62, 69, 1, 1, NULL, '2016-10-29 10:47:16'),
('twitter_username', 'Twitter - Username', 'braintrainke', 'Website Twitter username', '{"name":"value","label":"Value","type":"text"}', 0, 63, 64, 1, 1, NULL, '2016-10-29 10:47:29'),
...
('recaptcha_public_key', 'reCAPTCHA public key', '', 'reCAPTCHA public/site key', '{"name":"value","label":"Value","type":"text"}', 0, 71, 72, 1, 1, NULL, '2016-10-23 08:21:20'),
('recaptcha_private_key', 'reCAPTCHA private key', '', 'reCAPTCHA private/secret key', '{"name":"value","label":"Value","type":"text"}', 0, 73, 74, 1, 1, NULL, '2016-10-23 08:21:20'),
...
('app_cache_expire', 'Cache Expire duration', '60', 'Cache Expire duration (in seconds)', '{"name":"value","label":"Value","type":"text"}', 0, 114, 121, 1, 1, NULL, '2016-10-23 08:21:20'),
('app_cookie_expire', 'Cookie Expire duration', '2592000', 'Cookie Expire duration (in seconds)', '{"name":"value","label":"Value","type":"text"}', 0, 115, 116, 1, 1, NULL, '2016-10-23 08:21:20'),
...
('facebook_page_fans', 'Total Facebook page fans', '3043', 'Company Facebook page total number of fans', '{"name":"value","label":"Value","type":"text"}', 0, 47, 48, 1, 1, NULL, '2016-10-23 08:21:20');
INSERT INTO `<<prefix>>settings` (`key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`)
VALUES
	('purchase_code', 'Push Notification Code', '', 'OneSignal Push Notification Code', '{"name":"value","label":"Value","type":"text"}', 0, 6, 7, 1, 1, NULL, '2016-11-10 19:29:35');
INSERT INTO `<<prefix>>settings` (`key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`)
VALUES
	('meta_description', 'Meta description', '', 'The website meta description', '{"name":"value","label":"Value","type":"textarea"}', 0, 5, 6, 1, 1, NULL, '2016-11-16 19:06:12');
INSERT INTO `<<prefix>>settings` (`key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) 
VALUES
	...
	('admin_email_notification', 'Admin Email Notification', '0', 'Send email notifications to the system admins when ads are added, users are registered etc.', '{"name":"value","label":"Activation","type":"checkbox"}', 0, 26, 33, 1, 1, NULL, '2017-01-13 14:38:08'),
	('payment_email_notification', 'Payment Email Notification', '0', 'Send Email Notifications to admins and user when payments are done.', '{"name":"value","label":"Activation","type":"checkbox"}', 0, 26, 33, 1, 1, NULL, '2017-01-13 14:38:08');
INSERT INTO `<<prefix>>settings` (`key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) 
VALUES
	('ads_per_page', 'Ads per page', '12', 'Number of ads per page (range > 4 and < 40)', '{"name":"value","label":"Value","type":"text"}', 0, 18, 19, 1, 1, NULL, '2017-02-08 13:51:10'),
...
VALUES
	...
	('app_favicon', 'Favicon', NULL, 'Favicon (can support extensions: png,jpg)', '{"name":"value","label":"Favicon","type":"image","upload":"true","disk":"uploads","default":"app/default/ico/favicon.png"}', 0, 4, 4, 1, 1, NULL, '2017-02-24 9:15:38'),
	('unactivated_ads_expiration', 'Inactive ads Expiration', '30', 'In days (Delete the Inactive ads after this expiration) - You need to add "/usr/bin/php -q /path/to/your/website/artisan ads:clean" in your Cron Job tab', '{"name":"value","label":"Value","type":"text"}', 0, 25, 25, 1, 1, NULL, '2017-03-14 19:31:10'),
	('activated_ads_expiration', 'Active ads Expiration', '150', 'In days (Archive the Active ads after this expiration) - You need to add "/usr/bin/php -q /path/to/your/website/artisan ads:clean" in your Cron Job tab', '{"name":"value","label":"Value","type":"text"}', 0, 25, 25, 1, 1, NULL, '2017-03-14 19:31:10'),
	...
	('app_email_sender', 'Transactional Email Sender', NULL, 'Used to send all transactional email address from the website to the receiver. Example: noreply@domain.com', '{"name":"value","label":"Value","type":"email"}', 0, 9, 10, 1, 1, NULL, '2017-03-22 09:27:49');
